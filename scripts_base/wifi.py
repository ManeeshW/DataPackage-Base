...
class WifiClient(threading.Thread):
    def __init__(self, thread_id, freq=100):
        ...
        print('WIFI Client 1: initialized')


    def run(self):
        print('WIFI Client 1: starting  thread')
        ...
        with socket.socket(socket.AF_INET, socket.SOCK_STREAM) as s:
            ...
            print('WIFI Client 1: sending turn off cammand to rover')
            for i in range(10):
                ...
                try:
                    ...
                    print('WIFI Client 1: error reading sending data to server')
                time.sleep(0.1)

        print('WIFI Client 1: thread closed')
    ...
    def update_data(self):
        ...
        gps = GpsData(
            ...
            self._server_data.utc_seconds,
            self._server_data.utc_nanos
        )
        ...
        cam1 = Cam1Data(
            self._server_data.t_cam1,
            self._server_data.freq_cam1,
            self._server_data.idx_cam1
        )
        cam2 = Cam2Data(
            self._server_data.t_cam2,
            self._server_data.freq_cam2,
            self._server_data.idx_cam2
        )
        ...
        rover.update_cam1(cam1)
        rover.update_cam2(cam2)
...
class WifiServer(threading.Thread):
    def __init__(self, thread_id, freq=100):
        ...
        print('WIFI Server: initialized')


    def run(self):
        print('WIFI Server: starting Server thread ')
        ...
        with socket.socket(socket.AF_INET, socket.SOCK_STREAM) as s:
            ...
            with conn:
                print('WIFI Server: connected by ', addr)
                ...
                while self._on:
                    ...
                    try:
                        ...
                        print('WIFI Server: server closed')
                        break
                    except:
                        print('WIFI Server: error reading receiving from client')
        ...
        print('WIFI Server: thread closed')
