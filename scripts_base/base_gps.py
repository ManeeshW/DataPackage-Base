...
from common_types import GpsData, base


class SwiftnavPiksiMulti(threading.Thread):

    def __init__(self, thread_id, port, baud, t0, enabled, freq=5):
                    ...
                    try:
                        ...
                        for msg, metadata in source.filter(msg_list):
                            ...
                            # GPS time
                                ...
                                with self._lock:
                                    self._wn = msg.wn # week number wn
