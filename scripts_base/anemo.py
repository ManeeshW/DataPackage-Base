...
from common_types import AnemoData, rover, base


class Anemo(threading.Thread):

    def __init__(self, thread_id, port, baud, bits, parity, index, t0, enabled, mini_mode, \
            freq=10.0):
    ...
    def run(self):
        ...
        try:
            temp = serial.Serial(self._port, self._baud, self._bits,
                                 self._parity, serial.STOPBITS_ONE)
        ...
        with serial.Serial(self._port, self._baud, self._bits,
                           self._parity, serial.STOPBITS_ONE) as s:
    ...
    def parse_big_anemometer(self, line):
        ...
        try:
            ...
            ret = True
            #print("ok ",temp," | ", uvw[0]," | ", uvw[1]," | ", uvw[2] )
        except:
            ret = False
            print('ANEMO: error processing data')
    ...
    def update_data(self):
        ...
        base.update_ane(self._index, data)
